...
gates: check-isa check-obj-layout check-base-paths check-boot-order check-path-literals check-boot-amalgam check-pin check-release-manifest check-bootstrap check-doc-vocab check-dup-defs check-bare-globals check-dialect-cover ## Run the contract gates
.PHONY: gates
