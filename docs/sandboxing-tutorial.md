...
layout contract — `ext/x-engine-c/tools/contract/base-paths.x`, one row per field — and
...
- `ext/x-engine-c/tools/contract/base-paths.x` — the layout contract both `cell`
