...
- [Primitives and core forms](primitives.md) — the C instruction set, the coordinates reached through `prim-ref`, and the operatives and procedures that boot on top (hand-written)
