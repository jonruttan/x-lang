...
(`ext/x-eval-c/tools/contract/base-paths.x`) to the object the type-rooted row for
...
(`ext/x-eval-c/tools/contract/base-paths.x`) to the object the base-rooted row for
