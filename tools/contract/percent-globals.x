...
(file "lib/x/core/predicates.x" 13)
(file "lib/x/core/quasi.x" 1)
(file "lib/x/core/syntax.x" 5)
(file "lib/x/doc/doc-gen.x" 27)
(file "lib/x/doc/doc.x" 74)
...
(file "lib/x/tool/asm-compile.x" 65)
