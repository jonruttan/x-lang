...
#                                             the digest of ext/x-eval-c/tools/contract/isa.x,
...
: > build/release/SHASUMS.tmp
{
  ...
  printf '(release "%s")\n' "$TAG"
  isa=$(_digest ext/x-eval-c/tools/contract/isa.x)
  check_hex "$isa" ext/x-eval-c/tools/contract/isa.x
  printf '(isa "sha256:%s")\n' "$isa"
