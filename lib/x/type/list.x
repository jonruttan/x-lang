...
(def-class List ()
  (static
    ...
    (method min (self lst)
      ...
      (if (null? lst) (error "List min: empty list")
    ...
    (method max (self lst)
      ...
      (if (null? lst) (error "List max: empty list")
    ...
    (method unzip (self lst)
      (doc "Invert zip: a list of two-element lists becomes a list of two lists." (param lst LIST "List of (a b) two-element lists") (returns LIST "(firsts seconds)") (example "(List unzip (List zip (list 1 2) (list \"a\" \"b\")))" "((1 2) (\"a\" \"b\"))"))
      (list (List map first lst)
            (List map (fn (_ p) (first (rest p))) lst)))
