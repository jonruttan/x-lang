...
x_obj_t *x_type_whitespace_struct(x_obj_t *p_base, x_obj_t *p_obj)
{
	struct x_type_t type = {
		.p_name = x_type_whitespace_name,
		.p_analyse = x_sexp_whitespace_analyse1_prim,
		.p_delimit = x_sexp_whitespace_delimit_prim
	};
...
{
	x_spair_t args[2] = {
		x_obj_set(NULL, X_OBJ_FLAG_NONE, { x_type_whitespace_name }, { (x_obj_t *)(args + 1) }),
		x_obj_set(NULL, X_OBJ_FLAG_NONE, { x_type_whitespace_struct_prim }, { NULL })
	};
