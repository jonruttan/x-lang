...
static char *test_arith_sum(void)
{
	...
	p_args = x_mkspair(p_base, NULL,
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)10),
...
static char *test_arith_prod(void)
{
	...
	/* (* 4 5) -> 20 */
	p_args = x_mkspair(p_base, NULL,
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)4),
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)5), NULL)));
	...
	p_args = x_mkspair(p_base, NULL,
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)0),
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)100), NULL)));
	p_result = x_prim_prod(p_base, p_args);
...
static char *test_arith_div(void)
{
	...
	/* (/ 20 5) -> 4 */
	p_args = x_mkspair(p_base, NULL,
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)20),
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)5), NULL)));
	p_result = x_prim_div(p_base, p_args);
...
static char *test_arith_bitwise(void)
{
	...
	/* (& 0xFF 0x0F) -> 0x0F */
	p_args = x_mkspair(p_base, NULL,
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)0xFF),
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)0x0F), NULL)));
	p_result = x_prim_bitand(p_base, p_args);
	_it_should("(& 0xFF 0x0F) = 0x0F", x_intval(p_result) == 0x0F);

	/* (| 0xF0 0x0F) -> 0xFF */
	p_args = x_mkspair(p_base, NULL,
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)0xF0),
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)0x0F), NULL)));
...
static char *test_arith_shift(void)
{
	...
	/* (>> 16 4) -> 1 */
	p_args = x_mkspair(p_base, NULL,
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)16),
		x_mkspair(p_base, x_mksatom(p_base, (x_int_t)4), NULL)));
