...
static char *test_arith_sub(void)
{
	...
	/* (- 5) -> -5 (unary negate) */
	p_args = x_mkspair(p_base,
		x_mksatom(p_base, (x_int_t)5), NULL);
	p_result = x_prim_sub(p_base, p_args);
